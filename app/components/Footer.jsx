...
const Footer = () => {        
    return (
        <section className="bg-gray-50 sm:pt-10 lg:pt-16 py-5 -mt-16">
            <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                        <Link href="/"><h2 className=" font-bold text-md text-black">Payless4tech</h2></Link>
                    ...
                    <div className="col-span-2 md:col-span-1 lg:col-span-2 lg:pl-8">
                        <p className="text-sm font-semibold tracking-widest text-black uppercase">Subscribe to get product updates</p>

                        <form action="#" method="POST" className="mt-6 flex flex-1 gap-2">
                            <div>
                                <label for="email" className="sr-only">Email</label>
                                <input type="email" name="email" id="email" placeholder="Enter your email" className="block w-full p-3 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-blue-600 caret-blue-600" />
                            </div>

                            <button type="submit" className="inline-flex items-center justify-center px-3 py-2 font-semibold text-white transition-all duration-200 bg-gray-700 rounded-md hover:bg-gray-500 focus:bg-gray-700">Subscribe</button>
                        </form>
                    </div>
                </div>
                ...
                <p className="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by Payless4tech</p>
            </div>
        </section>
